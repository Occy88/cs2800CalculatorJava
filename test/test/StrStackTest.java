...
class StrStackTest {
  ...
  /**
   * Test #1 check {@link StrStack} existence
   */
  @Test
  void createStrStack() {
  ...
  /**
   * Test #2 check if {@link StrStack#push(String)} pushes entry into stack
   */
  @Test
  ...
  /**
   * Test #3 check if {@link StrStack#pop()} pops string from stack
   * 
  ...
  /**
   * Test #4 check if {@link StrStack#isEmpty()} returns true if stack is empty else false<br>
