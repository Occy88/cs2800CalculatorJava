...
class StackTest {
  ...
  /**
   * Test #1 Test to check for class {@link Stack} existence;
   */
  @Test
  ...
  /**
   * Test #2 Test for function push({@link Entry}) in class {@link Stack};
   */
  @Test
  ...
  /**
   * Test #3 Test for function size() returns number of entries in class {@link Stack};
   */
  @Test
  ...
  /**
   * Test #4 Test for function pop() which returns and removes newest entry in class {@link Stack};
   * 
   */
  @Test
  ...
  /**
   * Test #5 Test for function top() which returns and keeps newest entry in class {@link Stack};
   */
  @Test
  ...
  /**
   * Test #6 Test for function pop()for EmptyStackException in class {@link Stack};
   */
  @Test
  ...
  /**
   * Test #7 Test for function top() for EmptyStackException in class {@link Stack};
   */
  @Test
